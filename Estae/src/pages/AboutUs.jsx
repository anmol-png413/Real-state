  ...
  return (
    <PolicyLayout title="About Us">
      ...
      <section>
        ...
        <p className="text-gray-600">Business Email: <a href="mailto:info@trueeliteestate.com" className="text-yellow-600 hover:underline">info@trueeliteestate.com</a></p>
