  ...
  {exploreLinks.map((link) => (
    ...
    >
      ...
      <a
        ...
        style={{ background: "#f5c842", textDecoration: "none" }}
      >
      ...
      >
        <svg width="16" height="16" viewBox="0 0 24 24" fill="white" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M12 0C5.373 0 0 5.373 0 12c0 2.123.554 4.118 1.523 5.847L.057 23.882a.5.5 0 00.606.61l6.204-1.63A11.955 11.955 0 0012 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 22c-1.891 0-3.666-.523-5.184-1.433l-.372-.22-3.853 1.013 1.036-3.765-.243-.386A9.959 9.959 0 012 12C2 6.477 6.477 2 12 2s10 4.477 10 10-4.477 10-10 10z"/>
        </svg>
        <span style={{
          fontFamily: "'DM Sans', sans-serif",
          fontSize: "11px",
