...
Locator:  locator('.lg\\:hidden form').first()
Expected: visible
Received: hidden
Timeout:  5000ms
...
Call log:
  ...
  - waiting for locator('.lg\\:hidden form').first()
    13 × locator resolved to <form>…</form>
...
- textbox "Your Name"
- paragraph: Enter your name
- textbox "Phone Number"
- paragraph: Valid 10-digit number
- button "I'm Interested In... ▼"
- paragraph: Please select
