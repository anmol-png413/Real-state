...
- Name: lead-forms.spec.js >> Group 3 · Form Validation >> TC-18 · Mobile Hero Form: empty submit shows validation (no API call)
- Location: tests/lead-forms.spec.js:394:3
