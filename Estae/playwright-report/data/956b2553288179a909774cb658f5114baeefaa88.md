...
- Name: lead-forms.spec.js >> Group 2 · Standalone Forms >> TC-15 · Mobile Sticky Form bottom sheet → source = 'Mobile Sticky Form'
- Location: tests/lead-forms.spec.js:322:3
...
Locator:  locator('button:has-text(\'Get Best Price\')').first()
Expected: visible
Received: hidden
Timeout:  6000ms
...
Call log:
  ...
  - waiting for locator('button:has-text(\'Get Best Price\')').first()
    15 × locator resolved to <button type="submit">Get Best Price →</button>
