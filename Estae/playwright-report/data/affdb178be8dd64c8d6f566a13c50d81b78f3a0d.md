...
- Name: lead-forms.spec.js >> Group 4 · Post-Submit Redirect >> TC-21 · Mobile Hero Form submit → redirects to /thank-you
- Location: tests/lead-forms.spec.js:451:3
...
Locator:  locator('.md\\:hidden form').first()
Expected: visible
Received: hidden
Timeout:  10000ms
...
Call log:
  ...
  - waiting for locator('.md\\:hidden form').first()
