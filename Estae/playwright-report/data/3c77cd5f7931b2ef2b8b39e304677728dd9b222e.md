...
- Name: lead-forms.spec.js >> Group 1 · Modal ContactForm CTAs >> TC-11 · Download Prices floating button → source = 'Download Prices'
- Location: tests/lead-forms.spec.js:233:3
...
Locator: locator('button, a').filter({ hasText: /Download Prices|Price List/i }).and(locator('.hidden.md\\:block, .hidden.lg\\:block').locator('button, a')).first()
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('button, a').filter({ hasText: /Download Prices|Price List/i }).and(locator('.hidden.md\\:block, .hidden.lg\\:block').locator('button, a')).first()
