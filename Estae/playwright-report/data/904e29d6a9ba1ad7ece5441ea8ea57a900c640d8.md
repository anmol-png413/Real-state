...
- Name: lead-forms.spec.js >> Group 1 · Modal ContactForm CTAs >> TC-05 · Overview Section CTA → source = 'Overview'
- Location: tests/lead-forms.spec.js:117:3
...
Locator: locator('#overview').getByRole('button', { name: /book|get/i }).first()
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('#overview').getByRole('button', { name: /book|get/i }).first()
