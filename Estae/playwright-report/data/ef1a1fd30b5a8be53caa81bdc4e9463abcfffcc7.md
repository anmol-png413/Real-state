...
- Name: lead-forms.spec.js >> Group 1 · Modal ContactForm CTAs >> TC-10 · Download Brochure floating button → source = 'Download Brochure'
- Location: tests/lead-forms.spec.js:212:3
...
Locator: locator('button, a').filter({ hasText: /Download Brochure/i }).and(locator('.hidden.md\\:block, .hidden.lg\\:block').locator('button, a')).first()
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('button, a').filter({ hasText: /Download Brochure/i }).and(locator('.hidden.md\\:block, .hidden.lg\\:block').locator('button, a')).first()
