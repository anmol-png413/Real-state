...
- Name: lead-forms.spec.js >> Group 6 · Mobile Bottom Bar >> TC-25 · 'Call Now' button has valid tel: href
- Location: tests/lead-forms.spec.js:547:3
...
Call log:
  ...
  - waiting for locator('a[href^="tel:"]').first()
    22 × locator resolved to <a href="tel:9711557670" class="flex-1 flex items-center justify-center gap-1.5 py-3">…</a>
