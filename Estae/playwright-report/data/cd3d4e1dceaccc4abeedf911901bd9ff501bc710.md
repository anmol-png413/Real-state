...
- Name: lead-forms.spec.js >> Group 1 · Modal ContactForm CTAs >> TC-09 · Footer CTA → source = 'Footer'
- Location: tests/lead-forms.spec.js:193:3
...
Locator: locator('footer').getByRole('button', { name: /book|get/i }).first()
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('footer').getByRole('button', { name: /book|get/i }).first()
